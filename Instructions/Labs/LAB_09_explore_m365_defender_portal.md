...
1. Sur la page d’accueil du portail Microsoft 365 Defender, sélectionnez **Niveau de sécurité Microsoft** dans la barre de titre de la carte (le texte sera bleu).  Vous pouvez également sélectionner **Niveau de sécurité** dans le volet de navigation de gauche.
